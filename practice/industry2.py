...
#     data["Agriculture"] = data["Industries"].str.contains(Agriculture)
    Financial_Services =("Accounting, Angel Investment, Asset Management, Auto Insurance, Banking, Commercial Insurance, Commercial Lending, Consumer Lending, Credit, Credit Bureau, Credit Cards, Debit Cards, Debt Collections, Finance, Financial Exchanges, Financial Services,  Fraud Detection,  Gift Card, Health Insurance, Hedge Funds, Impact Investing, Incubators, Insurance,  Leasing, Lending, Life Insurance, Micro Lending,  Payments, Personal Finance, Prediction Markets, Property Insurance, Real Estate Investment, Stock Exchanges, Transaction Processing, Venture Capital,  Wealth Management, Angel Investment, Banking, Commercial Lending, Consumer Lending, Credit, Credit Cards, Financial Exchanges, Funding Platform, Hedge Funds, Impact Investing, Incubators, Micro Lending, Stock Exchanges, Trading Platform, Venture Capital").replace(', ', '|' )
...
#     data["Financial_Services"] = data["Industries"].str.contains(Lending_Investments)
# ---------------------------------------------------------------------------------------------------------------------------    
    
    Financial_Services_Tech =("FinTech, Cryptocurrency, Funding Platform, InsurTech, Mobile Payments, Trading Platform, Billing, Bitcoin, Credit Cards, Cryptocurrency, Debit Cards, Fraud Detection, Mobile Payments, Payments, Transaction Processing, Virtual Currency").replace(', ', '|' )
    data["Financial_Services_Tech"] = data["Industries"].str.contains(Financial_Services_Tech)
        
                          
# ---------------------------------------------------------------------------------------------------------------------------  
    Information_Technology =("Business Information Systems, CivicTech, Cloud Data Services, Cloud Management, Cloud Security, CMS, Contact Management, CRM, Cyber Security, Data Center, Data Center Automation, Data Integration, Data Mining, Data Visualization, Document Management, E-Signature, Email, GovTech, Identity Management, Information and Communications Technology (ICT), Information Services, Information Technology, Intrusion Detection, IT Infrastructure, IT Management, Management Information Systems, Messaging, Military, Network Security, Penetration Testing, Private Cloud, Reputation, Sales Automation, Scheduling, Social CRM, Spam Filtering, Unified Communications, Video Chat, Video Conferencing, Virtualization, VoIP, A/B Testing, Analytics, Application Performance Management, Artificial Intelligence, Big Data, Bioinformatics, Biometrics, Business Intelligence, Consumer Research, Data Integration, Data Mining, Data Visualization, Database, Facial Recognition, Geospatial, Image Recognition, Intelligent Systems, Location Based Services, Machine Learning, Market Research, Natural Language Processing, Predictive Analytics, Product Research, Quantified Self, Speech Recognition, Test and Measurement, Text Analytics, Usability Testing, Artificial Intelligence, Intelligent Systems, Machine Learning, Natural Language Processing, Predictive Analytics, Bioinformatics, Biometrics, Biopharma, Biotechnology, Genetics, Life Science, Neuroscience, Quantified Self").replace(', ', '|' )
...
#     data["Information_Technology"] = data["Industries"].str.contains(Data_Analytics)     
...
#     data["Information_Technology"]=data["Industries"].str.contains(Artificial_Intelligence)
...
#     data["Software"] = data["Industries"].str.contains(Apps)
...
#     data["Software"] = data["Industries"].str.contains(Messaging_Telecommunications)                           
    
#     Gaming =("Casual Games, Contests, Fantasy Sports, Gambling, Gamification, Gaming, MMO Games, Online Games, PC Games, Serious Games, Video Games").replace(', ', '|' )                           
#     data["Software"] = data["Industries"].str.contains(Gaming)                           

# ---------------------------------------------------------------------------------------------------------------------------     
    Hardware =("3D Technology, Application Specific Integrated Circuit (ASIC), Augmented Reality, Cloud Infrastructure, Communication Hardware, Communications Infrastructure, Computer, Computer Vision, Consumer Electronics, Data Center, Data Center Automation, Data Storage, Drone Management, Drones, DSP, Electronic Design Automation (EDA), Electronics, Embedded Systems, Field-Programmable Gate Array (FPGA), Flash Storage, Google Glass, GPS, GPU, Hardware, Industrial Design, Laser, Lighting, Mechanical Design, Mobile Devices, Network Hardware, NFC, Nintendo, Optical Communication, Playstation, Private Cloud, Retail Technology, RFID, RISC, Robotics, Roku, Satellite Communication, Semiconductor, Sensor, Sex Tech, Telecommunications, Video Conferencing, Virtual Reality, Virtualization, Wearables, Windows Phone, Wireless, Xbox, 3D Printing, Advanced Materials, Foundries, Industrial Automation, Industrial Engineering, Industrial Manufacturing, Machinery Manufacturing, Manufacturing, Paper Manufacturing, Plastics and Rubber Manufacturing, Textiles, Wood Processing, Computer, Consumer Electronics, Drones, Electronics, Google Glass, Mobile Devices, Nintendo, Playstation, Roku, Smart Home, Wearables, Windows Phone, Xbox,Android, Google Glass, iOS, mHealth, Mobile, Mobile Apps, Mobile Devices, Mobile Payments, Windows Phone, Wireless").replace(', ', '|' )
...
#     data["Hardware"] = data["Industries"].str.contains(Manufacturing)
...
#     data["Media_Entertainment"] = data["Industries"].str.contains(Content_Publishing)
